class MicrocategoryMock {
    static mockMicrocategories = {
        ...
        "Транспорт":                     [{"Автомобили": [{"Audi": ["Q5", "Q7"]}, {"BMW": ["M5", "X5"]}]}, "Запчасти и аксессуары", "Грузовики и спецтехника", "Водный транспорт", "Мотоциклы и мототехника"],
...
module.exports = MicrocategoryMock
